...
For the visualizations of categorical variables the [OK Cupid dataset](https://github.com/rudeboybert/JSE_OkCupid) will be used.

```{r cupid_data}
#| echo: false

cupid <- read_csv("data/okcupid.csv", name_repair = "unique")
```
