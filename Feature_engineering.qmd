...
When rare occurences are not to be eliminated, they can be concatenated into a new category (e.g. "other") when their respective occurrences fall below a predefined threshold.
